...
func beaconSettingsForConfig(_ config: BeaconConfig) -> [ESTSettingReadWrite] {
    ...
    return [
        ...
        ESTSettingDeviceInfoGeoLocation(value: ESTDeviceGeoLocation(latitude: NSNumber(value: config.geoLocation.latitude), longitude: NSNumber(value: config.geoLocation.longitude))),
