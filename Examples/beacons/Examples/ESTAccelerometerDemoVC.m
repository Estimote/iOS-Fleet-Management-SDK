...
@interface ESTAccelerometerDemoVC () <ESTBeaconConnectionDelegate>
...
- (void)vibrateEffect
{
    if (self.beaconConnection.inMotion && self.beaconConnection.connectionStatus == ESTConnectionStatusConnected)
    {
