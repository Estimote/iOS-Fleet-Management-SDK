 ...
 */
extern NSString * const ESBulkUpdaterBeginNotification;
 ...
 */
extern NSString * const ESBulkUpdaterProgressNotification;

/**
 *  The object associated with the notification is the bulk updater.
 */
extern NSString * const ESBulkUpdaterCompleteNotification;

/**
 *  Notification used to inform user about timeout.
 */
extern NSString * const ESBulkUpdaterTimeoutNotification;
 ...
 */
@interface ESBulkUpdater : NSObject
 ...
 */
- (void)startWithBeaconInfos:(NSArray *)beacons
